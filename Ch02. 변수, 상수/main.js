...
- 변수
  ...
  - 값은 영역안에 같은 식별자를 가진 변수는 추가 생성이 불가능하다.
*/
...
// let functuin - 'abc'; // 예약어를 사용할 수 없음

/*
네이밍 규칙 (주로 카멜 케이스 사용)
- 카멜 케이스
  - 중간 단어의 첫 글자가 대문자이며 낙타의 혹처럼 보인다고 해서 카멜 케이스라고 불린다.
    ex) camelCase

- 스네이크 케이스
  - 언더바가 들어있는 표현 방식이 뱀처럼 생겼다고해서 스네이크 케이스 라고 불린다.
    ex) snake_case
