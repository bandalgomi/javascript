...
/*
객체 생성
- 리터럴 방식 : 중괄호{} 안에 key: value 형태로 쉼표로 구분하여 생성
...
//객체로 전달하기
function printPerson2(name, age, hobby) {
    console.log("이름: " + name + " 나이: " + age + "취미: " + hobby);
}
const objPerson = {
    name: "전현우",
...
// Call by Value: 기본 타입(원서 타입, 프리미티브 타입) 호출
...
// Call By Refarence: 참조 타입(객체 타입) 호출
